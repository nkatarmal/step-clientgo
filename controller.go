...
func NewController(
	...
	fooInformer informers.StepInformer) *Controller {
	...
	controller := &Controller{
		...
		workqueue:         workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "Steps"),
		recorder:          recorder,
	}
...
func (c *Controller) handleObject(obj interface{}) {
	...
	if ownerRef := metav1.GetControllerOf(object); ownerRef != nil {
		...
		foo, err := c.foosLister.Steps(object.GetNamespace()).Get(ownerRef.Name)
		if err != nil {
